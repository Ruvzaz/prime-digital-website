    ...
    <main className="min-h-screen pt-24 md:pt-32 pb-20 bg-[#F8FAFC]">
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 mb-20">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-slate-200/80">
            <h3 className="text-lg font-bold text-[#0D278A] mb-6 flex items-center gap-2">
              <span className="w-1.5 h-6 bg-[#0D278A] rounded-full"></span>
              {t("about.helpTitle")}
            </h3>
      ...
      {/* 3) Highlights */}
      <section className="bg-white py-20 mb-20 border-y border-slate-200/60">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {highlights.map((item, index) => (
              <div
                key={index}
                className="bg-[#F8FAFC] rounded-2xl p-8 border border-slate-200/60 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
              >
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 pb-12">
        <div className="grid md:grid-cols-2 gap-12">
          {/* Mindset */}
          <div className="bg-gradient-to-br from-[#0D278A] to-[#06154B] rounded-3xl p-8 md:p-10 text-white shadow-xl hover:shadow-2xl transition-shadow duration-300">
          ...
          {/* Team */}
          <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-slate-200/80 flex flex-col justify-center">
            <h3 className="text-xl font-bold text-slate-900 mb-4">{t("about.team.title")}</h3>
