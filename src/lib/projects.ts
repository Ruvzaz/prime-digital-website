export type Project = {
  ...
  category_th: string;
  category_en: string;
  tags_th?: string[]; // เพิ่มรองรับหลาย Tag (ถ้าไม่ได้ระบุจะดึงจาก category_th อัตโนมัติ)
  tags_en?: string[]; // เพิ่มรองรับหลาย Tag (ถ้าไม่ได้ระบุจะดึงจาก category_en อัตโนมัติ)
...
export function getProjectContent(project: Project, lang: "th" | "en") {
  const explicitTags = project[`tags_${lang}`];
  const categoryStr = project[`category_${lang}`] || "";
  const derivedTags = categoryStr
    ? categoryStr.split("·").map((s) => s.trim()).filter(Boolean)
    : [];
  const tags = explicitTags && explicitTags.length > 0 ? explicitTags : derivedTags;
...
export const PROJECTS: Project[] = [
  {
    ...
    description_en:
      "Consulting for the Digital Volunteer Network Development Project to develop citizens with volunteer spirit interested in digital technology, serving as representatives to assist and provide guidance on important missions of the Ministry of Digital Economy and Society operating in the area",
    overview_th:
      "โครงการยุทธศาสตร์เพื่อสร้างและพัฒนา 'อาสาสมัครดิจิทัล' (อสด.) ให้เป็นกลไกหลักในการขับเคลื่อนสังคมดิจิทัลระดับฐานราก โดยบริษัทรับผิดชอบการบริหารจัดการโครงการแบบครบวงจร (End-to-End) ตั้งแต่การพัฒนาแพลตฟอร์มดิจิทัล (Web & App) การออกแบบหลักสูตรและจัดอบรมเชิงปฏิบัติการใน 4 ภูมิภาค ไปจนถึงการติดตามผลการขยายความรู้สู่ประชาชนในชุมชนกว่า 6,000 ราย",
    overview_en:
    ...
    problem_th:
      "การขับเคลื่อนดิจิทัลระดับประเทศมักประสบปัญหา 'ช่องว่าง' ระหว่างนโยบายกับการปฏิบัติจริงในพื้นที่ชุมชน ขาดบุคลากรที่มีความพร้อมในการถ่ายทอดความรู้ และขาดเครื่องมือ (Tools) ที่ทันสมัยในการบริหารจัดการอาสาสมัคร ทำให้การเข้าถึงบริการดิจิทัลของรัฐยังไม่ครอบคลุมทุกพื้นที่",
    problem_en:
      "National digital transformation often faces a 'gap' between policy and ground-level implementation. Challenges included a shortage of capable personnel to transfer digital knowledge locally and a lack of modern tools to manage volunteer networks effectively, resulting in uneven access to government digital services.",
    solution_th:
      "เราใช้แนวทาง 'Tech + Touch' ในการแก้ปัญหา: 1) Tech: ยกระดับแอปพลิเคชัน อสด. ให้ใช้งานง่ายและเชื่อมโยงข้อมูลได้จริง 2) Touch: จัดค่ายอบรมเข้มข้น 4 ภาค สร้าง 'Train the Trainer' ที่มีความรู้จริง และ 3) Mechanism: สร้างระบบติดตามผลการขยายความรู้แบบ Multi-tier (จากวิทยากร -> อสด. -> ประชาชน) เพื่อให้มั่นใจว่าเกิดผลลัพธ์จริง",
    solution_en:
      "We implemented a 'Tech + Touch' approach: 1) Tech: Upgraded the TDV application for better usability and seamless data integration. 2) Touch: Organized intensive regional training camps to produce capable 'Trainers'. 3) Mechanism: Established a multi-tier monitoring system (Experts -> Volunteers -> Public) to ensure tangible knowledge transfer outcomes.",
    outcome_th:
      "ประสบความสำเร็จในการสร้างแกนนำอาสาสมัครดิจิทัลกว่า 320 คนที่มีศักยภาพสูง พร้อมด้วยเครื่องมือแอปพลิเคชันที่เสถียร สามารถนำความรู้ไปขยายผลสอนต่อให้กับประชาชนในพื้นที่ได้จริงตามเป้าหมายกว่า 6,400 ราย เกิดเป็นเครือข่ายความร่วมมือที่เข้มแข็งในการลดความเหลื่อมล้ำทางดิจิทัล",
    outcome_en:
      "Successfully empowered over 320 high-potential Digital Volunteer leaders equipped with stable digital tools. These volunteers effectively expanded their reach, transferring digital skills to over 6,400 citizens in local communities, thereby establishing a strong collaborative network to bridge the digital divide.",
    gallery: [
  ...
  },
  {
    ...
    category_th: "Cyber",
    category_en: "Cyber",
    tags_th: ["Cyber", "Security", "Youth Camp"],
    tags_en: ["Cyber", "Security", "Youth Camp"],
    ...
    description_en:
      "Designed and conducted Cyber Youth Camp to build 'strong digital citizens' through learning experiences in cybersecurity, media literacy, critical thinking, and creative technology use, combining hands-on activities with simulated scenarios to prepare youth for the rapidly changing online world",
    overview_th:
      "โครงการพัฒนาศักยภาพเยาวชนด้านความมั่นคงปลอดภัยไซเบอร์ (Cyber Youth Camp) ภายใต้การกำกับดูแลของสำนักงานคณะกรรมการการรักษาความมั่นคงปลอดภัยไซเบอร์แห่งชาติ (สกมช.) เพื่อสร้างบุคลากรไซเบอร์รุ่นใหม่ที่มีทักษะตามมาตรฐานสากล ผ่านกระบวนการคัดกรองเข้มข้นและการอบรมเชิงปฏิบัติการแบบเจาะลึก",

    overview_en:
      "The 'Cyber Youth Camp' initiative, commissioned by the National Cyber Security Agency (NCSA), aims to cultivate a new generation of cybersecurity talent equipped with international-standard skills. The project involves a rigorous screening process followed by intensive, hands-on training workshops.",
    ...
    problem_th:
      "ภัยคุกคามทางไซเบอร์ทวีความรุนแรงและซับซ้อน ส่งผลกระทบต่อความมั่นคงของชาติและเศรษฐกิจ ในขณะที่ประเทศไทยยังประสบปัญหาขาดแคลนบุคลากรที่มีความเชี่ยวชาญเฉพาะด้าน และเยาวชนยังขาด 'ภูมิคุ้มกัน' ในการรับมือกับความเสี่ยงบนโลกออนไลน์",

    problem_en:
      "Cyber threats are becoming increasingly severe and complex, impacting national security and the economy. Meanwhile, Thailand faces a critical shortage of skilled cybersecurity professionals, and the youth population lacks the necessary 'digital immunity' to navigate online risks effectively.",

    solution_th:
      "ออกแบบกระบวนการเรียนรู้แบบ Hybrid Learning: เริ่มต้นด้วยการคัดกรองผ่าน Online Workshop ที่วัดผลได้จริง และต่อยอดด้วย 'Intensive Camp' ที่เน้นการลงมือทำ (Simulation & Practice) ภายใต้การดูแลของวิทยากรผู้เชี่ยวชาญและหลักสูตรที่ผ่านการรับรองจากคณะทำงาน เพื่อให้มั่นใจว่าผู้เรียนได้ทักษะที่นำไปใช้ได้จริง",

    solution_en:
      "Implemented a Hybrid Learning approach: Starting with a measurable Online Workshop for screening, followed by an 'Intensive Camp' focused on Simulation & Practice. The program is guided by certified experts and a validated curriculum to ensure practical skill acquisition.",

    outcome_th:
      "สามารถผลิตเยาวชนที่มีทักษะความมั่นคงปลอดภัยไซเบอร์จำนวน 2 รุ่น (รวมกว่า 100 คน) ที่ผ่านการทดสอบสมรรถนะตามเกณฑ์ ได้รับสื่อการเรียนรู้คุณภาพสูง (หนังสือกว่า 100 หน้า) และเกิดเครือข่ายเยาวชนไซเบอร์ที่พร้อมเป็นกำลังสำคัญให้กับประเทศในอนาคต",

    outcome_en:
      "Successfully empowered two batches of youth (over 100 participants) with verified cybersecurity competencies. Deliverables included high-quality learning resources (100+ page guidebooks) and the establishment of a strong youth cyber network ready to support the nation's digital future.",
    gallery: [
  ...
  },
  {
    ...
    title_th:
      "กิจกรรมยกระดับสมรรถนะประชากรเพื่อให้พร้อมเข้าสู่การเป็นพลเมืองดิจิทัล",
    ...
    problem_th:
      "พฤติกรรมการเสพสื่อที่เปลี่ยนแปลงไปและการแพร่ระบาดของข่าวปลอม (Fake News) ส่งผลกระทบต่อสังคม ในขณะที่ประชากรกลุ่มเปราะบาง (เช่น ผู้สูงอายุ ผู้ด้อยโอกาส) ยังขาดทักษะการรู้เท่าทันสื่อและดิจิทัล (Digital Literacy) อีกทั้งเครื่องมือวัดระดับสมรรถนะเดิมยังไม่ครอบคลุมบริบททักษะแห่งอนาคต",

    problem_en:
      "Shifting media consumption habits and the spread of Fake News pose social challenges. Meanwhile, vulnerable groups (e.g., the elderly, the underprivileged) lack essential Media and Information Literacy (MIL). Furthermore, existing assessment tools fail to cover the context of Future Skills required for the digital era.",

    solution_th:
      "ใช้กลยุทธ์ 'Targeted Digital Empowerment': 1) พัฒนาหลักสูตรที่ 'Customized' ให้เข้ากับบริบทของแต่ละกลุ่มวัย 2) สร้างระบบวัดผลที่ทันสมัย (Modernized Assessment) บน Cloud ภาครัฐ 3) ใช้ศูนย์ดิจิทัลชุมชนเป็นฐานในการกระจายความรู้ผ่านระบบ Conference เพื่อให้เข้าถึงกลุ่มเป้าหมายในพื้นที่ห่างไกลได้อย่างทั่วถึง",

    solution_en:
      "Deployed a 'Targeted Digital Empowerment' strategy: 1) Developed 'Customized' curricula suited to specific age groups/contexts. 2) Built a Modernized Assessment system on the Government Cloud. 3) Leveraged Digital Community Centers as hubs to disseminate knowledge via conference systems, ensuring reach to remote areas.",

    outcome_th:
      "ยกระดับทักษะดิจิทัลให้กับประชาชนกลุ่มเป้าหมายครบ 5,000 รายตามสัญญา มีระบบฐานข้อมูลและ Dashboard ที่ใช้งานได้จริงสำหรับการกำหนดนโยบาย พร้อมทั้งได้กรอบสมรรถนะดิจิทัลฉบับใหม่ที่ผ่านการเทียบเคียงมาตรฐานสากลจากการศึกษาดูงานต่างประเทศ",

    outcome_en:
      "Successfully elevated digital skills for the full target of 5,000 citizens. Delivered a functional database and Dashboard for policy-making, along with a revised Digital Competency Framework benchmarked against international standards through strategic study trips.",
    gallery: [
  ...
  },
  {
    ...
    title_th:
      "ข้อมูลระบบลงทะเบียนฉีดวัคซีน ซิโนฟาร์ม องค์การบริหารส่วนจังหวัดสมุทรปราการ",
    title_en:
      "Sinofarm Vaccination Registration System - Samut Prakan Provincial Administrative Organization",
    ...
    description_en:
      "Designed Sinofarm vaccination registration system for Samut Prakan PAO - a digital system to support registration, screening, and data management of vaccine applicants under proactive operations to enhance public health services, increase transparency, reduce redundancy, and accommodate high user volumes",
  },
  {
    id: 5,
    ...
    title_th:
      "ข้อมูลสถานภาพการรู้เท่าทันสื่อสารสนเทศ และการเข้าใจดิจิทัล ประจำปี พ.ศ. 2568",
    title_en:
      "Media and Information Literacy and Digital Understanding Status Report 2025",
    ...
    description_en:
      "Designed 'Media and Information Literacy and Digital Understanding Status Report 2025' presenting an overview of Thai citizens' digital skill levels in data analysis, news verification, cybersecurity, and responsible technology use to reflect the real situation and guide capacity development in the digital age",
  },
  {
    id: 6,
    ...
    problem_th:
      "ตามนโยบายกระทรวงดิจิทัลฯ ที่ต้องการให้สำนักงานสถิติจังหวัดเพิ่มบทบาทเป็นผู้นำด้านดิจิทัลในระดับภูมิภาค (One Roof Policy) แต่บุคลากรเดิมยังขาดทักษะที่จำเป็น (Competency Gap) และยังไม่มีกรอบมาตรฐานที่ชัดเจนในการประเมินความพร้อมหรือแนวทางในการปรับเปลี่ยนองค์กรให้สอดคล้องกับบริบทใหม่",
    ...
    solution_th:
      "ใช้กระบวนการ 'Assess - Design - Implement': 1) Assess: ประเมิน Gap ของคนและโครงสร้างพื้นฐานด้วยเครื่องมือดิจิทัล 2) Design: ออกแบบหลักสูตร Re-skill/Up-skill ที่ตรงจุด 3) Implement: จัด Workshop นำร่องเพื่อสร้าง 'Change Agents' ใน 18 จังหวัด และลงพื้นที่ประกบเพื่อทำแผนพัฒนาเฉพาะจังหวัด (Provincial Roadmap)",

    solution_en:
      "Deployed an 'Assess - Design - Implement' methodology: 1) Assess: Evaluated personnel and infrastructure gaps using digital tools. 2) Design: Created targeted Re-skill/Up-skill curricula. 3) Implement: Conducted pilot workshops to cultivate 'Change Agents' in 18 provinces, followed by on-site consulting to develop specific Provincial Roadmaps.",

    outcome_th:
      "ได้ต้นแบบกรอบสมรรถนะและแผนพัฒนาองค์กรที่ชัดเจน บุคลากรใน 18 จังหวัดนำร่องได้รับการยกระดับทักษะจนสามารถจัดทำแผนขับเคลื่อนดิจิทัลของจังหวัดตนเองได้ และมีสื่อการเรียนรู้ e-Learning มาตรฐานที่บุคลากรใน 76 จังหวัดสามารถใช้ทบทวนเพื่อพัฒนาตนเองได้อย่างยั่งยืน",

    outcome_en:
      "Delivered a validated Competency Framework and Organizational Development Plan. Personnel in 18 pilot provinces were upskilled to create their own provincial digital roadmaps. Additionally, a standardized e-Learning library was established, enabling continuous self-development for staff across all 76 provinces.",
    gallery: [
  ...
  },
  {
    ...
    problem_th:
      "แม้ภาครัฐจะมีชุดข้อมูลจำนวนมาก แต่ยังขาดการนำไปใช้ประโยชน์อย่างเต็มประสิทธิภาพ (Underutilized Data) เนื่องจากผู้ใช้ยังขาดความรู้ความเข้าใจในการเข้าถึง ขาดทักษะในการวิเคราะห์ข้อมูล (Data Analytics Skills) และชุดข้อมูลบางส่วนยังไม่เชื่อมโยงกันหรืออยู่ในรูปแบบที่พร้อมใช้งาน (Ready-to-use)",

    problem_en:
      "Despite the abundance of government datasets, they remain 'Underutilized Data' due to a lack of user awareness on access, insufficient Data Analytics skills among stakeholders, and data often not being interconnected or in a ready-to-use format.",

    solution_th:
      "ดำเนินการด้วยกลยุทธ์ 'Data Activation 360°': 1) Tech: ยกระดับมาตรฐานข้อมูลด้วย Linked Open Data 2) People: อบรมทักษะการใช้ข้อมูลจริงด้วยเครื่องมือ BI Tools 3) Engagement: สร้างเวทีแลกเปลี่ยนเรียนรู้ผ่าน Roadshow ทั่วประเทศและดึงภาคการศึกษาเข้ามามีส่วนร่วม เพื่อให้ข้อมูลถูกนำไปสร้างมูลค่าจริง",
    ...
    outcome_th:
      "สร้างเครือข่ายผู้ใช้งานข้อมูลภาครัฐที่เข้มแข็งทั่วประเทศ บุคลากรกว่า 800 คนสามารถใช้เครื่องมือวิเคราะห์ข้อมูลเพื่อตอบโจทย์ภารกิจได้จริง เกิดการรับรู้ในวงกว้างผ่านสื่อประชาสัมพันธ์และกิจกรรม Roadshow นำไปสู่การยกระดับบัญชีข้อมูลภาครัฐให้เป็น 'National Data Infrastructure' ที่สมบูรณ์",

    outcome_en:
      "Established a robust network of government data users nationwide. Over 800 personnel were empowered with data analytics tools to solve real-world tasks. Broad awareness was achieved through PR campaigns and Roadshows, successfully elevating the Government Data Catalog to become a complete 'National Data Infrastructure'.",
    gallery: [
  ...
  },
  {
    ...
    year: "2025",
    title_th:
      "โครงการจ้างที่ปรึกษาจัดทำบัญชีข้อมูลองค์กร (Data Catalog) ขององค์การสวนสัตว์แห่งประเทศไทยฯ",
    title_en:
      "Consultancy Services Project for the Development of the Organization Data Catalog for the Zoological Park Organization of Thailand",
    category_th: "Data Catalog",
    category_en: "Data Catalog",
    description_th:
      "โครงการจ้างที่ปรึกษาจัดทำบัญชีข้อมูลองค์กร (Data Catalog) ขององค์การสวนสัตว์แห่งประเทศไทยฯ เพื่อให้ข้อมูลถูกนำไปสร้างมูลค่าจริง",
    description_en:
      "A digital transformation initiative empowering the Zoological Park Organization of Thailand to become a truly Data-Driven Organization. We established the foundational Data Architecture, consolidating fragmented wildlife conservation and tourism data into a unified 'Corporate Data Catalog.' This project enhances transparency and facilitates the utilization of data for research and public service improvement.",
    overview_th:
      "โครงการวางรากฐานการบริหารจัดการข้อมูลเชิงยุทธศาสตร์ให้กับองค์การสวนสัตว์แห่งประเทศไทยฯ โดยมุ่งเน้นการจัดทำสถาปัตยกรรมข้อมูล (Data Architecture) ที่ได้มาตรฐานสากล และพัฒนาระบบบัญชีข้อมูลองค์กร (Data Catalog) บนแพลตฟอร์ม CKAN เพื่อรวบรวมและเปิดเผยข้อมูลสำคัญด้านการอนุรักษ์และการให้บริการ สู่สาธารณะตามมาตรฐานข้อมูลเปิดภาครัฐ (Open Data)",
    overview_en:
    ...
    problem_th:
      "ระบบบริหารจัดการข้อมูลเดิมขาดความเชื่อมโยง (Siloed Data) และไม่มีโครงสร้างมาตรฐาน ทำให้การนำข้อมูลไปวิเคราะห์เพื่อตัดสินใจเชิงยุทธศาสตร์ทำได้ล่าช้า อีกทั้งข้อมูลด้านการอนุรักษ์และการให้บริการยังไม่ได้ถูกจัดระเบียบเพื่อเปิดเผยต่อสาธารณะอย่างมีประสิทธิภาพตามนโยบายรัฐบาลดิจิทัล",

    problem_en:
      "The existing data management system suffered from disconnected silos and lacked a standardized structure, causing delays in strategic data analysis. Furthermore, valuable conservation and service data were not organized efficiently for public disclosure in alignment with Digital Government policies.",

    solution_th:
      "วางโครงสร้างระบบนิเวศข้อมูลใหม่ (Data Ecosystem) โดยเริ่มจากการออกแบบ Data Architecture ที่ชัดเจน (ต้นน้ำถึงปลายน้ำ) กำหนดธรรมาภิบาลข้อมูล และใช้เครื่องมือ CKAN ในการสร้าง Data Catalog เพื่อเป็นศูนย์กลางในการเข้าถึงข้อมูลที่โปร่งใสและตรวจสอบได้",

    solution_en:
      "Established a new Data Ecosystem by designing a clear Data Architecture (end-to-end), defining Data Governance policies, and utilizing CKAN tools to build a centralized Data Catalog, ensuring transparent and auditable data access.",

    outcome_th:
      "องค์การสวนสัตว์ฯ มีระบบบัญชีข้อมูล (Data Catalog) ที่ทันสมัยและใช้งานได้จริงบน Cloud มีมาตรฐานการจัดการข้อมูลที่รองรับการขยายตัวในอนาคต และมีชุดข้อมูลเปิด (Open Data) คุณภาพสูงที่พร้อมให้บริการแก่นักวิจัยและประชาชน เพื่อสนับสนุนงานอนุรักษ์และเศรษฐกิจยุคใหม่",

    outcome_en:
      "ZPOT is equipped with a modern, functional Data Catalog hosted on Cloud, backed by scalable data management standards. The project delivered high-quality Open Data sets ready for researchers and the public, supporting conservation efforts and the modern data economy.",
    gallery: [
  ...
  },
  {
    ...
    year: "2024",
    title_th:
      "งานจ้างที่ปรึกษาขับเคลื่อนการประยุกต์ใช้ระบบสารสนเทศสนับสนุนการบริหารความเสี่ยง และควบคุมภายใน ขององค์การสวนสัตว์แห่งประเทศไทย ในพระบรมราชูปถัมภ์",
    title_en:
      "Consultancy Services for Driving the Application of the Information System Supporting Risk Management and Internal Control of the Zoological Park Organization of Thailand",
    category_th: "RISK Management",
    category_en: "RISK Management",
    description_th:
      "โครงการเปลี่ยนผ่านระบบบริหารความเสี่ยงสู่ยุคดิจิทัล (Digital Risk Transformation) เพื่อยกระดับธรรมาภิบาลองค์กรตามมาตรฐาน SE-AM เรานำเทคโนโลยี Business Intelligence และระบบเตือนภัยล่วงหน้า (Early Warning System) มาประยุกต์ใช้ เพื่อเปลี่ยนข้อมูลความเสี่ยงที่ซับซ้อน ให้กลายเป็น Dashboard ที่ดูง่ายและแจ้งเตือนได้ทันที ช่วยให้ผู้บริหารองค์การสวนสัตว์ฯ สามารถ 'รู้เท่าทัน' และ 'รับมือ' กับความเสี่ยงได้อย่างแม่นยำและรวดเร็ว",
    description_en:
      "A Digital Risk Transformation initiative designed to elevate corporate governance in compliance with SE-AM standards. We integrated Business Intelligence and Early Warning Systems (EWS) to transform complex risk data into intuitive Dashboards with instant alerts. This empowers ZPOT executives to 'Anticipate' and 'Mitigate' risks with precision and agility, ensuring organizational resilience.",
    overview_th:
      "โครงการที่ปรึกษาเชิงกลยุทธ์เพื่อยกระดับระบบบริหารความเสี่ยงและการควบคุมภายในขององค์การสวนสัตว์แห่งประเทศไทยฯ สู่ยุคดิจิทัล โดยมุ่งเน้นการปฏิบัติตามเกณฑ์ประเมินรัฐวิสาหกิจ (SE-AM) ผ่านการออกแบบระบบสารสนเทศอัจฉริยะ (Business Intelligence) และระบบเตือนภัยล่วงหน้า (Early Warning System) เพื่อให้ผู้บริหารสามารถตัดสินใจบนพื้นฐานของข้อมูลความเสี่ยงที่ทันต่อเหตุการณ์",
    ...
    problem_th:
      "การบริหารความเสี่ยงแบบเดิมยังขาดเครื่องมือดิจิทัลที่ช่วยในการติดตามและแจ้งเตือนสถานะความเสี่ยงได้ทันท่วงที (Real-time Monitoring) อีกทั้งต้องเร่งปรับปรุงกระบวนการทำงานให้สอดคล้องกับเกณฑ์ประเมินผลรัฐวิสาหกิจ (SE-AM) ฉบับใหม่ ที่เน้นการใช้ข้อมูลสารสนเทศมาสนับสนุนการตัดสินใจ",

    problem_en:
      "Traditional risk management lacked digital tools for real-time monitoring and alerting. Furthermore, there was an urgent need to align operational processes with the new State Enterprise Assessment Model (SE-AM), which prioritizes the use of information systems for data-driven decision-making.",

    solution_th:
      "วางระบบ 'Proactive Risk Intelligence' โดย: 1) เปลี่ยนการรายงานผลเป็นดิจิทัลด้วย E-Forms 2) สร้างระบบ EWS ที่มี Trigger Point เพื่อเตือนภัยก่อนเกิดเหตุ และ 3) แสดงผลผ่าน Dashboard ที่เข้าใจง่าย ช่วยให้เห็นภาพรวมความเสี่ยงทั้งองค์กรได้ในหน้าจอเดียว",

    solution_en:
      "Implemented a 'Proactive Risk Intelligence' system by: 1) Digitizing reporting via E-Forms. 2) Establishing an EWS with Trigger Points for preemptive alerts. 3) Visualizing data through comprehensive Dashboards, providing a single-pane-of-glass view of organizational risks.",

    outcome_th:
      "องค์การสวนสัตว์ฯ มีระบบต้นแบบในการบริหารความเสี่ยงที่ทันสมัย มีระบบ EWS ช่วยลดโอกาสเกิดความเสียหาย และมีบุคลากรที่มีความเข้าใจในการใช้เทคโนโลยีมาจัดการความเสี่ยง พร้อมรับการประเมินตามมาตรฐาน SE-AM อย่างมั่นใจ",

    outcome_en:
      "ZPOT is equipped with a modern risk management system prototype featuring an EWS to mitigate potential damages. Personnel are upskilled in leveraging technology for risk management, ensuring readiness for SE-AM assessment compliance.",
    gallery: [
  ...
  },
  {
    ...
    description_th:
      "โครงการที่เปรียบเสมือนการสร้าง 'ทางด่วนข้อมูล' ให้กับประเทศไทย เรามุ่งแก้ปัญหาข้อมูลภาครัฐที่กระจัดกระจายและคุยกันไม่รู้เรื่อง ด้วยการนำมาตรฐานโลกอย่าง SDMX มาเป็นตัวกลางในการเชื่อมโยงข้อมูลยุทธศาสตร์ชาติเข้าด้วยกัน และเปลี่ยนข้อมูลดิบให้กลายเป็นขุมทรัพย์ทางปัญญาด้วยเทคโนโลยี AI & Machine Learning เพื่อให้ทุกการตัดสินใจในการพัฒนาประเทศ ขับเคลื่อนด้วยข้อมูลที่ถูกต้อง แม่นยำ และทันสมัยที่สุด",
    description_en:
    ...
    problem_th:
      "ระบบบัญชีข้อมูลภาครัฐในปัจจุบันเปรียบเสมือน 'สมุดหน้าเหลือง' ที่บอกแหล่งที่มา แต่ตัวข้อมูลจริงยังขาดโครงสร้างที่เป็นมาตรฐาน (Unstructured Data) ทำให้ไม่สามารถนำมาประมวลผลร่วมกันหรือแลกเปลี่ยนอัตโนมัติได้ทันที เป็นอุปสรรคต่อการนำข้อมูลไปใช้วิเคราะห์เพื่อขับเคลื่อนยุทธศาสตร์ชาติ",

    problem_en:
      "The current Government Data Catalog functions like a 'Yellow Pages'—listing sources but lacking standard structures (Unstructured Data). This fragmentation prevents automated data exchange and interoperability, hindering the ability to analyze data effectively for driving the National Strategy.",

    solution_th:
      "ยกระดับโครงสร้างพื้นฐานข้อมูลโดยใช้มาตรฐาน **SDMX** เพื่อสร้าง 'ภาษากลาง' ในการแลกเปลี่ยนข้อมูลสถิติ ทำให้ข้อมูลจากต่างหน่วยงานสามารถเชื่อมโยงกันได้อัตโนมัติ (Automated Exchange) และต่อยอดด้วยการใช้ **AI/Simulation** มาช่วยวิเคราะห์หาทางเลือกที่คุ้มค่าที่สุดในการแก้ปัญหาประเทศ",

    solution_en:
      "Upgraded the data infrastructure by adopting the **SDMX** standard to create a 'Common Language' for statistical exchange. This enables Automated Exchange between agencies and facilitates the use of **AI/Simulation** to analyze and identify the most cost-effective solutions for national challenges.",

    outcome_th:
      "เกิดระบบนิเวศการแลกเปลี่ยนข้อมูลสถิติที่เป็นมาตรฐานสากล (SDMX) เป็นครั้งแรกในหน่วยงานนำร่อง มีชุดข้อมูลยุทธศาสตร์ที่พร้อมใช้งาน (Ready-to-use) และ Dashboard ที่แสดงสถานะการพัฒนาประเทศแบบ Real-time ช่วยให้รัฐบาลมีข้อมูลที่แม่นยำในการกำหนดนโยบาย",

    outcome_en:
      "Established a pilot ecosystem for international-standard statistical data exchange (SDMX). Delivered ready-to-use strategic datasets and real-time Dashboards monitoring national development, empowering the government with accurate data for precision policy-making.",
    gallery: [
