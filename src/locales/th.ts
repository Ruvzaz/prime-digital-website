export const th = {
  ...
  "hero.card.footer":
    "เราออกแบบแนวทางให้เหมาะกับสภาพแวดล้อมจริงขององค์กร ไม่ใช่โซลูชันสำเร็จรูปที่ใช้ได้กับทุกแห่ง",

  // === Services Section ===
  "services.subtitle": "OUR SERVICES",
  "services.title": "บริการหลักของเรา",
  "services.description":
    "ครอบคลุมตั้งแต่การวางกลยุทธ์ดิจิทัล การออกแบบสถาปัตยกรรมระบบ ไปจนถึงการพัฒนาและส่งมอบโซลูชันที่ใช้งานได้จริงในองค์กรของคุณ",
  ...
  "portfolio.description":
    "รวมตัวอย่างบางส่วนของโครงการด้านการออกแบบระบบ พัฒนา backend และแดชบอร์ดข้อมูล ที่เราช่วยองค์กรภาครัฐและเอกชนออกแบบและส่งมอบ โดยเน้นผลลัพธ์ที่ใช้งานได้จริงในบริบทขององค์กร",
  "portfolio.view": "ดูรายละเอียด",
  "portfolio.cta": "สนใจโปรเจกต์นี้",
  "portfolio.technicalNote":
  ...
  "about.hero.description":
    "พาร์ตเนอร์ที่ปรึกษาดิจิทัลระดับมืออาชีพ ที่มุ่งออกแบบกลยุทธ์ สถาปัตยกรรมระบบ และแดชบอร์ดข้อมูลเพื่อยกระดับการตัดสินใจขององค์กร",
  "about.intro.title": "เราคือที่ปรึกษาและวางสถาปัตยกรรมดิจิทัลองค์กร",
  "about.intro.paragraph1":
    "Prime Digital Consultant Co., Ltd. เป็นบริษัทที่ปรึกษาด้านดิจิทัลระดับมืออาชีพ เชี่ยวชาญการประเมินความพร้อมระบบ (System Audit) การออกแบบสถาปัตยกรรมคลาวด์และพัฒนาเว็บแอปพลิเคชันเฉพาะองค์กร การทำแดชบอร์ดวิเคราะห์ข้อมูลผู้บริหาร ตลอดจนการกำกับดูแลความปลอดภัยไซเบอร์ตามมาตรฐาน NCSA และ ISO",
  "about.intro.paragraph2":
    "เรามุ่งเน้นการนำเทคโนโลยีที่เหมาะสมมาปรับใช้จริง ไม่ขายของเกินจำเป็น และเน้นการปรับให้เข้ากับบริบทของแต่ละองค์กร",
  ...
  "about.highlights.item1.desc":
    "เชี่ยวชาญทั้งด้านการตลาด เทคโนโลยี และข้อมูล พร้อมประสบการณ์ทำงานกับองค์กรรัฐบาลและเอกชน",
  "about.highlights.item2.title": "การบริการใกล้ชิด ยืดหยุ่น",
  "about.highlights.item2.desc":
    "ดูแลแบบพาร์ตเนอร์ เข้าใจบริบทจริงของลูกค้า และปรับแผนงานให้สอดคล้องกับสถานการณ์",
  "about.highlights.item3.title": "เทคโนโลยีและนวัตกรรมที่เหมาะสม",
  "about.highlights.item3.desc":
    "เลือกใช้เฉพาะเทคโนโลยีที่ตอบโจทย์และยั่งยืน ไม่เน้นขายของ ไม่เน้นของเกินจำเป็น",
  "about.mindset.title": "วิธีคิดในการทำงานของเรา",
  "about.mindset.paragraph1":
    '"เราเชื่อว่าดิจิทัลคือเครื่องมือ ไม่ใช่คำตอบทั้งหมด แต่หากใช้อย่างถูกวิธีจะช่วยให้องค์กรเดินไปข้างหน้าอย่างมั่นคง"',
  "about.mindset.paragraph2":
    "ทุกโปรเจกต์ของเรามีพื้นฐานจากข้อมูลจริง การทดลอง และการปรับปรุงอย่างต่อเนื่อง เพื่อให้ระบบอยู่ได้ในระยะยาว",
  "about.team.title": "ทีมของเรา",
  "about.team.description":
    "ทีมงานประกอบด้วยที่ปรึกษา นักวิเคราะห์ และฝ่ายเทคนิค พร้อมประสบการณ์จากหลากหลายอุตสาหกรรมและภาครัฐ",
  "about.team.note":
    "* ส่วนนี้สามารถเพิ่มภาพทีม บทบาท หรือโปรไฟล์สมาชิกภายหลังได้ เพื่อให้ลูกค้ามองเห็นภาพมากขึ้น",
  ...
  "services.page.description":
    "เราโฟกัสการช่วยองค์กรออกแบบและพัฒนาระบบดิจิทัลในส่วนที่มีความซับซ้อนสูง ทั้งด้านกลยุทธ์ สถาปัตยกรรมระบบ และการใช้ข้อมูลให้เกิดประโยชน์สูงสุด โดยเชื่อมโยงกับเป้าหมายทางธุรกิจเป็นหลัก",
  ...
  "portfolio.page.description":
    "โปรเจกต์ที่เราได้ออกแบบและส่งมอบให้กับลูกค้า แสดงถึงความเชี่ยวชาญและประสบการณ์ของทีมงาน",
  ...
  "contact.description":
    "หากคุณต้องการที่ปรึกษาด้านกลยุทธ์ดิจิทัล การออกแบบระบบ หรือแดชบอร์ดด้านข้อมูล สามารถส่งรายละเอียดเบื้องต้นถึงเราได้ ทีมงานจะติดต่อกลับโดยเร็วที่สุด",
  "contact.leftTitle": "เล่าให้เราฟังสั้น ๆ ว่าต้องการความช่วยเหลือด้านไหน",
  "contact.leftDescription":
    "คุณไม่จำเป็นต้องมี requirement ที่สมบูรณ์แล้ว แค่บอกปัญหาและเป้าหมายหลัก ๆ ของคุณ เราจะช่วยออกแบบแนวทางที่เหมาะสมให้",
  "contact.otherChannels": "ช่องทางติดต่ออื่น",
  "contact.email": "อีเมล",
  "contact.phone": "โทร",
  "contact.privacyNote":
    "* ข้อมูลที่คุณส่งจะถูกเก็บรักษาอย่างปลอดภัย และใช้เพื่อการติดต่อกลับเท่านั้น",
  "contact.formSubmitAlert":
    "ตอนนี้เป็นแบบฟอร์มตัวอย่าง (ยังไม่เชื่อมระบบส่งจริง)",
